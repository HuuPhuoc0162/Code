...
var Adidas = [
    ...
    new giay("A02", "Adidas", "/assets/img/Adidas/Adidas Ultraboost FZ2558 Men.png", "Adidas Ultraboost FZ2558 Men", [38, 39, 40, 41, 42, 43], ["Trắng", "Đen"], 5000000, 10,
    ...
    new giay("A04", "Adidas", "/assets/img/Adidas/Adidas Ultraboost S23873.jpg", "Adidas Ultraboost S23873", [38, 41, 42, 43], ['Trắng', 'Đen', 'Xanh Dương'], 4500000, 10,
    ...
    new giay("A05", "Adidas", "/assets/img/Adidas/Adidas Pureboost Jet Women GW9146.jpg", "Adidas Pureboost Jet Women GW9146", [35, 36, 38, 39], ['Trắng', 'Xanh Lam'], 3400000, 10,
    ...
    new giay("A06", "Adidas", "/assets/img/Adidas/Adidas Supernova 2 Men GW9092.jpg", "Adidas Supernova 2 Men GW9092", [38, 39, 41, 43], ['Trắng', 'Xanh Lá'], 2700000, 10,
    ...
    new giay("A07", "Adidas", "/assets/img/Adidas/Adidas Supernova Women GX0535-3.jpg", "Adidas Supernova Women GX0535-3", [36, 37, 38, 39], ['Trắng', 'Đen'], 2925000, 10,
    ...
    new giay("A08", "Adidas", "/assets/img/Adidas/Adidas Supernova Men GX2962.jpg", "Adidas Supernova Men GX2962", [39, 42, 43], ['Trắng', 'Đen', 'Xanh Dương'], 2850000, 10, `
...
var Nike = [
    new giay("N01", "Nike", "/assets/img/Nike/Nike Air Max DC9332-001 Men.jpg", "Nike Air Max DC9332-001 Men", [38, 39, 40, 42, 43], ['Trắng', 'Xanh Dương'], 5000000, 10,
    ...
    new giay("N02", "Nike", "/assets/img/Nike/Unisex Nike CV7562-104.jpg", "Unisex Nike CV7562-104", [37, 38, 39, 40], ['Trắng'], 4700000, 10,
    ...
    new giay("N03", "Nike", "/assets/img/Nike/Nike Air Max DH4245-400 Men.jpg", "Nike Air Max DH4245-400", [38, 39, 42, 43], ['Trắng', 'Đen'], 4700000, 10,
    ...
    new giay("N04", "Nike", "/assets/img/Nike/Nike React Infinity Run Fk 2 CT2357-009.jpg", "Nike React Infinity Run Fk 2 CT2357-009", [41, 42, 43], ['Trắng', 'Đen'], 4700000, 10,
    ...
    new giay("N05", "Nike", "/assets/img/Nike/Nike Zoom Fly 4 CT2392-005.jpg", "Nike Zoom Fly 4 CT2392-005", [37, 41, 42, 43], ['Đen', 'Xám'], 4700000, 10,
    ...
    new giay("N06", "Nike", "/assets/img/Nike/Nike Zoom Vomero 16 DA7698-003 Women.jpg", "Nike Zoom Vomero 16 DA7698-003 Women", [35, 36, 37, 38, 39], ['Trắng', 'Đen'], 3970000, 10,
    ...
    new giay("N07", "Nike", "/assets/img/Nike/Nike Air Max DC9336-400 Men.jpg", "Nike Air Max DC9336-400 Men", [38, 39, 40, 41, 42, 43], ['Trắng', 'Xanh Dương'], 3800000, 10,
    ...
    new giay("N08", "Nike", "/assets/img/Nike/Nike Zoom Pegasus 38 DQ4994-010 Men.jpg", "Nike Zoom Pegasus 38 DQ4994-010 Men", [38, 39, 42, 43], ['Trắng', 'Đen'], 3640000, 10,
...
var Puma = [
    new giay("P01", "Puma", "/assets/img/Puma/Puma Run Xx Nitro 376171-02 Women.jpg", "Puma Run Xx Nitro 376171-02 Women", [37, 38, 39, 40], ['Trắng', 'Hồng', 'Đen'], 3600000, 10,
    ...
    new giay("P02", "Puma", "/assets/img/Puma/Puma Velocity Nitro 2 376262-01 Women.jpg", "Puma Velocity Nitro 2 376262-01 Women", [35, 36, 37, 39], ['Trắng', 'Đen'], 3510000, 10,
    ...
    new giay("P03", "Puma", "/assets/img/Puma/Puma RS 306536-01 Unisex.jpg", "Puma RS 306536-01 Unisex", [35, 36, 37, 38, 43], ['Trắng'], 3330000, 10,
    ...
    new giay("P04", "Puma", "/assets/img/Puma/Puma Court Rider 2.0 376646-01 Men.jpg", "Puma Court Rider 2.0 376646-01 Men", [41, 42, 43], ['Đen', 'Cam'], 3150000, 10,
    ...
    new giay("P05", "Puma", "/assets/img/Puma/Unisex Puma 195196-03.jpg", "Unisex Puma 195196-03", [35, 38, 39, 40], ['Xanh Lá', 'Đen'], 3150000, 10,
    ...
    new giay("P06", "Puma", "/assets/img/Puma/Lifestyle Unisex Puma Bmw Mms Maco 306995-02.jpg", "Lifestyle Unisex Puma Bmw Mms Maco 306995-02", [35, 36, 41, 42, 43], ['Đen'], 3150000, 10,
    ...
    new giay("P07", "Puma", "/assets/img/Puma/Puma RS 372429-01 Unisex.jpg", "Puma RS 372429-01 Unisex", [35, 36, 37, 38, 39, 43], ['Xanh Dương', 'Trắng'], 3150000, 10,
    ...
    new giay("P08", "Puma", "/assets/img/Puma/Puma RS 380562-04 Unisex.jpg", "Puma RS 380562-04 Unisex", [35, 36, 37, 38, 39, , 43], ['Trắng', 'Đen'], 2880000, 10,
...
var Converse = [
    new giay("C01", "Converse", "/assets/img/Converse/Converse Chuck 70 Seasonal Color - A01448C.jpg", "Converse Chuck 70 Seasonal Color", [35, 36, 37, 42, 43], ['Đỏ', 'Trắng'], 1900000, 10,
    ...
    new giay("C02", "Converse", "/assets/img/Converse/Converse Chuck Taylor All Star 70 Plus.jpg", "Converse Chuck Taylor All Star 70 Plus", [35, 36, 37, 42, 43], ['Trắng', 'Đen'], 2500000, 10,
    ...
    new giay("C03", "Converse", "/assets/img/Converse/Converse Chuck Taylor All Star Dainty.jpg", "Converse Chuck Taylor All Star Dainty", [35, 36, 40, 41], ['Trắng', 'Đen'], 1500000, 10,
    ...
    new giay("C04", "Converse", "/assets/img/Converse/Converse Chuck Taylor All Star Lift Platform Canvas.jpg", "Converse Chuck Taylor All Star Lift Platform Canvas", [35, 36, 37, 38, 39, 40, 41], ['Trắng'], 1620000, 10,
    ...
    new giay("C05", "Converse", "/assets/img/Converse/Converse Chuck Taylor All Star 1970s Recycled Rpet Canvas.jpg", "Converse Chuck Taylor All Star 1970s Recycled Rpet Canvas", [35, 36, 39, 40, 41, 42, 43], ['Trắng', 'Hồng'], 1710000, 10,
    ...
    new giay("C06", "Converse", "/assets/img/Converse/Converse Chuck Taylor All Star CX Explore Roots.jpg", "Converse Chuck Taylor All Star CX Explore Roots", [35, 38, 41, 42, 43], ['Xám'], 2000000, 10,
    ...
    new giay("C07", "Converse", "/assets/img/Converse/Converse Chuck Taylor All Star Renew.jpg", "Converse Chuck Taylor All Star Renew", [35, 37, 38, 41, 43], ['Trắng', 'Xanh Lá'], 1440000, 10,
    ...
    new giay("C08", "Converse", "/assets/img/Converse/Converse Chuck Taylor All Star Create Future.jpg", "Converse Chuck Taylor All Star Create Future", [39, 40, 41, 42, 43], ['Trắng', 'Đỏ'], 1440000, 10,
...
var Vans = [
    new giay("V01", "Vans", "/assets/img/Vans/Vans Old Skool Checker.jpg", "Vans Old Skool Checker", [35, 36, 37, 38, 41, 42, 43], ['Trắng', 'Đen'], 1600000, 10,
    ...
    new giay("V04", "Vans", "/assets/img/Vans/Vans SK8-Hi BW.jpg", "Vans SK8-Hi BW", [35, 38, 39, 40, 43], ['Trắng', 'Đen'], 1000000, 10,
    ...
    new giay("V06", "Vans", "/assets/img/Vans/Vans Old Skool Black White.jpg", "Vans Old Skool Black White", [35, 36, 42, 43], ['Trắng', 'Đen'], 1600000, 10,
        `Được gọi vui một cách thân thuộc là “giày Vans đen“, thực chất đây là một trong những phiên bản đầu tiên và cổ điển nhất của VANS
    ...
    new giay("V02", "Vans", "/assets/img/Vans/Vans UA Classic Slip-On SF Mix Match.jpg", "Vans UA Classic Slip-On SF Mix Match", [38, 39, 40, 41, 42, 43], ['Trắng'], 1305000, 10,
    ...
    new giay("V03", "Vans", "/assets/img/Vans/Vans UA Old Skool Vans Collage.jpg", "Vans UA Old Skool Vans Collage", [35, 36, 37, 38, 39, 40, 41], ['Trắng', 'Đen'], 670000, 10,
    ...
    new giay("V05", "Vans", "/assets/img/Vans/Vans UA Authentic Eco Theory Positivity.jpg", "Vans UA Authentic Eco Theory Positivity", [35, 36, 38, 39, 40, 42, 43], ['Trắng'], 1700000, 10,
    ...
    new giay("V07", "Vans", "/assets/img/Vans/Vans UA Old Skool Pig Suede.jpg", "Vans UA Old Skool Pig Suede", [35, 36, 37, 40, 41, 42, 43], ['Vàng'], 1980000, 10,
    ...
    new giay("V08", "Vans", "/assets/img/Vans/Vans UA Old Skool Tiger Floral.jpg", "Vans UA Old Skool Tiger Floral", [35, 36, 41, 42, 43], ['Trắng', 'Đen'], 1575000, 10,
